-- ============================================================
-- Migración 0005: columna descripcion en locomotoras
...
alter table public.locomotoras add column if not exists descripcion text;

-- Auditamos también la descripción en el historial de locomotoras
